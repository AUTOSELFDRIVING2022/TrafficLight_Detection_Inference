...
def detect(save_img=True):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # Apply Classifier
        if classifyTL or classifyEC:
            pred = apply_classifier(pred, modelTL, modelEC, img, im0s, save_cls_img, names)
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if save_img:
                ...
                if export_video_result: # 'video' or 'stream'
