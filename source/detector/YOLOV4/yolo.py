...
class YOLO(object):
    _defaults = {
        #"model_path":   '/workspace/NETWORK/pytorch-yolov4-deepsort/model_data/yolo4_weights.pth',
        "model_path":   '/workspace/NETWORK/pytorch-yolov4-deepsort/model_data/yolov4-obj_best_darknet.weights',
        "anchors_path": '/workspace/NETWORK/pytorch-yolov4-deepsort/model_data/yolo_anchors.txt',
        "classes_path": '/workspace/NETWORK/pytorch-yolov4-deepsort/model_data/coco_classes.txt',
