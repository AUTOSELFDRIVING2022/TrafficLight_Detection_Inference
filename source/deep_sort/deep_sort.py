...
class DeepSort(object):
    def __init__(self, model_path, max_dist=0.2, \
        ...
        #----added by deyiwang
        # namesfile = '/workspace/NETWORK/pytorch-yolov4-deepsort/model_data/coco_classes.txt'
    ...
    def update(self, bbox_xyxy, confidences, ori_img):
        ...
        bbox_tlwh = self._x1y1x2y2_to_tlwh(bbox_xyxy)
    ...
    """
    TODO:
            Convert bbox from x1_y1_x_2_y2 to xtl_ytl_w_h
    Thanks gnzrg25@gmail.com for reporting this bug!
    """
    def _x1y1x2y2_to_tlwh(self, bbox_x1y1x2y2):
        tlwh_box = []
        for box in bbox_x1y1x2y2:
            ...
            new_box.append(x1)
            new_box.append(y1)
            new_box.append(int(x2-x1))
            new_box.append(int(y2-y1))
            tlwh_box.append(new_box)
        return tlwh_box
